...
def main(argv, stdout, environ):
    all_dir = os.listdir("/home/jmji/DexterousHandEnvs/assets/urdf/blender/origin_obj/")
    print(all_dir)
    for dir in all_dir:
        all_obj_files = os.listdir("/home/jmji/DexterousHandEnvs/assets/urdf/blender/origin_obj/{}".format(dir))
